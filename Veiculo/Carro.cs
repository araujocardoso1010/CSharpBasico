namespace Veiculo
{
    public class Carro : Veiculo
    {
        ...
        public override int Capacidade
        {
            ...
            set
            {
                if(value >= 2 && value <= 7) capacidade = value;
                else
                {
        ...
        public override void Mover(double distanciaKm)
        {
            ...
            {
                Console.WriteLine("Não há gasolina suficiente para percorrer a distância informada.");
            }
        }

        public override void Frear()
        {
            Console.WriteLine("Acionando freios ABS... Parou!");
        }
